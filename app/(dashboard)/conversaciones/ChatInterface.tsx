        ...
        <div className="flex-1 overflow-y-auto">
          {cargando ? (
            ...
            <div className="flex flex-col items-center justify-center h-40 gap-2">
              ...
              <p className="text-sm" style={{ color: 'rgba(255,255,255,0.25)' }}>Sin conversaciones</p>
            </div>
          ) : (
                ...
                <button key={conv.id} onClick={() => setConvActiva(conv)}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[13px] shrink-0 ml-2" style={{ color: 'rgba(255,255,255,0.25)' }}>
                        {timeAgo(conv.last_activity_at)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between mt-0.5">
                      <p className="text-[14px] truncate" style={{ color: 'rgba(255,255,255,0.3)' }}>
                        {lastMsg?.content ?? 'Sin mensajes'}
                      </p>
                      {hasUnread && (
                        <span className="shrink-0 ml-2 w-5 h-5 rounded-full flex items-center justify-center text-[13px] font-bold"
          ...
          <>
            ...
            <div className="flex items-center gap-3 px-5 py-3 shrink-0"
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[13px]" style={{ color: 'rgba(6,182,212,0.5)' }}>
